        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
          {cityStats.map((city, index) => (
            <motion.article
              ...
              className="surface card-hover overflow-hidden rounded-3xl"
            >
              ...
              <div className="p-4">
                <div className="flex items-center justify-between">
                  <h3 className="font-extrabold text-[#1F2937]">{city.name}</h3>
                  <ArrowUpRight size={17} className="text-[#0F766E]" />
                </div>
