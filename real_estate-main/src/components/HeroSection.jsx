      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 pb-16 pt-16 sm:px-6 lg:grid-cols-[1.02fr_.98fr] lg:px-8 lg:pb-20 lg:pt-20">
        ...
        >
          <motion.div
            ...
            className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#D7E7E4] bg-white px-3 py-2 text-sm font-semibold text-[#134E4A] shadow-sm"
          >
          ...
          <motion.h1
            ...
            className="max-w-3xl text-5xl font-extrabold leading-[1.03] tracking-normal text-[#1F2937] md:text-7xl"
          >
          ...
          <motion.div
            ...
            className="soft-surface mt-9 rounded-[28px] p-4"
          >
          ...
          <div className="mt-8 grid max-w-xl grid-cols-3 gap-4">
            {stats.map(([value, label], index) => (
              <motion.div
                ...
                whileHover={{ y: -3 }}
                className="rounded-2xl border border-[#E5E7EB] bg-white p-4 transition-shadow duration-300 hover:shadow-md"
              >
        ...
        >
          <div className="animate-float">
            <img
              ...
              className="h-[420px] w-full rounded-[32px] object-cover shadow-2xl sm:h-[480px] lg:h-[520px]"
            />
          </div>
          <motion.div
            ...
            className="absolute bottom-5 left-5 right-5 rounded-3xl bg-white/88 p-5 shadow-xl backdrop-blur transition-shadow duration-300 hover:shadow-2xl"
          >
